...
const TransformationForm = ({action, data = null, userId, creditBalance, type, config = null}: 
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {(type === "remove" || type === "recolor") && (
          <div className="prompt-field">
            ...
            control={form.control}
            name="prompt"
            formLabel={type === 'remove' ? 'Objetct to remove' : 'Object to recolor'}
            className="w-full"
            render={({field}) => (
              <Input 
              value={field.value}
